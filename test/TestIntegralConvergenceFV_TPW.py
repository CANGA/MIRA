...
# -*- coding: utf-8 -*-
"""
TEST FOR QUADRATURE CONVERGENCE FROM SAMPLED TPW DATA
@author: jeguerra
"""
import numpy as np
import math as mt
...
# RUN: ./makeGridConvergenceData_N64_TPW.sh
...
for mm in range(4):
       ...
       fnameO1 = 'sample_NM64_O1_outCSne' + str(meshRes[mm]) + '_TPW.nc'
       fidO1 = Dataset(fnameO1, 'r')
       fnameO4 = 'sample_NM64_O8_outCSne' + str(meshRes[mm]) + '_TPW.nc'
       fidO4 = Dataset(fnameO4, 'r')
       
       # Get the sampled data
       thisValues = fidO1.variables['TotalPrecipWater'][:]
       thisAvgs = fidO4.variables['TotalPrecipWater'][:]
...
plt.legend(('2nd Order', 'TPW',), loc='upper right')
