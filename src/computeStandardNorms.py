...
def computeStandardNorms(varConT, varS2T, varST, areaT,
                         jacobiansT, SpectralElement):
    ...
    L1Num = computeGlobalWeightedIntegral(
        NT, varConT, varDiff, areaT, jacobiansT, SpectralElement)
    L2Num = computeGlobalWeightedIntegral(
        NT, varConT, varDiff2, areaT, jacobiansT, SpectralElement)
    LinfNum = np.amax(varDiff)
    # Compute normalizations
    L1Den = computeGlobalWeightedIntegral(
        NT, varConT, np.abs(varST), areaT, jacobiansT, SpectralElement)
