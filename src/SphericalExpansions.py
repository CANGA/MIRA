...
saveOut = {'avgCoeffsTPW':avgCoeffsTPW, 'avgCoeffsCF':avgCoeffsCF, 'coeffsTOPO':coeffsTOPO}
...
poptTPW2, pcovTPW2 = curve_fit(func, degsTPW[20:endPoint], ampTPW[20:endPoint], bounds=bounds2)
# Fit the Cloud Fraction data (INDEXED TO EXTRACT SUBSET THAT IS BETTER FOR FIT)
poptCF1, pcovCF1 = curve_fit(func, degsCF[1:21], ampCF[1:21], bounds=bounds1)
poptCF2, pcovCF2 = curve_fit(func, degsCF[20:endPoint], ampCF[20:endPoint], bounds=bounds2)
...
poptTOPO1, pcovTOPO1 = curve_fit(func, degsTOPO[1:5], ampTOPO[1:5], bounds=bounds1)
poptTOPO2, pcovTOPO2 = curve_fit(func, degsTOPO[20:endPoint], ampTOPO[20:endPoint], bounds=bounds2)
...
with plt.style.context(('ggplot')):
       ...
       ax2.set(yscale='log', xscale='log', xlabel='Spherical harmonic degree', ylabel='Avg. Coefficient Amplitude')
       ax2.legend()
