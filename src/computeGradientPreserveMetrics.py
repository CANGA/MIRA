...
def computeGradientPreserveMetrics(
        varConT, gradsOnTM, varsOnTM, areaT, jacobiansT, SpectralElement):
    ...
    denom = computeGlobalWeightedIntegral(
        NT, varConT, varST2, areaT, jacobiansT, SpectralElement)

    H1num = computeGlobalWeightedIntegral(
        NT, varConT, H1num, areaT, jacobiansT, SpectralElement)
    H1_2num = computeGlobalWeightedIntegral(
        NT, varConT, eGradK2, areaT, jacobiansT, SpectralElement)
