...
python CANGAFieldGenDriver.py --pm convergenceMeshes/outCSne16.g --so 32 --nm 64 --evaluateGlobalTerrain --ExodusSingleConn
python CANGAFieldGenDriver.py --pm convergenceMeshes/outCSne32.g --so 32 --nm 64 --evaluateGlobalTerrain --ExodusSingleConn
python CANGAFieldGenDriver.py --pm convergenceMeshes/outCSne64.g --so 32 --nm 64 --evaluateGlobalTerrain --ExodusSingleConn
python CANGAFieldGenDriver.py --pm convergenceMeshes/outCSne128.g --so 32 --nm 64 --evaluateGlobalTerrain --ExodusSingleConn
